...
import it.saimao.tmktaicalendar.mmcalendar.util.ObjectBuilder;
...
public final class Config {
     ...
     */
    public static void initDefault(Function<Builder, ObjectBuilder<Config>> fn) {
        instance = fn.apply(new Builder()).build();
    }
