...
public class LanguageTranslator {
    ...
    private static final String[][] CATALOG = {
            ...
            {"Sabbath Eve", "အဖိတ်", "အဖိတ္", "တ္ၚဲတိၚ်", "ၽိတ်း", "အဖိတ်"},
            ...
            {"Late Tagu", "နှောင်းတန်ခူး", "ေႏွာင္းတန္ခူး", "နှောင်းဂိတုစဲ", "ႁႃႈတၢမ်းႁၢင်", "စဲၤလါချံ"},
            {"Late Kason", "နှောင်းကဆုန်", "ေႏွာင္းကဆုန္", "နှောင်းဂိတုပသာ်", "ႁူၵ်းတၢမ်းႁၢင်", "စဲၤဒ့ၣ်ညါ"},
